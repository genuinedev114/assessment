        ...
        <div class="auth-card" data-animate>
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span class="badge badge-pill" style="background: rgba(41, 208, 178, 0.2); color: #9df8e7; border: 1px solid rgba(41, 208, 178, 0.4);">Secure Login</span>
                </div>
                <p class="text-muted mb-4">Access your franchise command center and live analytics dashboard.</p>
                ...
                @if ($errors->any())
                    ...
                    <div class="d-none" data-flash-type="error" data-flash-title="Login failed" data-flash-message="{{ $errors->first() }}"></div>
                @endif

                <form method="POST" action="{{ route('login') }}" data-animate>
                    @csrf
